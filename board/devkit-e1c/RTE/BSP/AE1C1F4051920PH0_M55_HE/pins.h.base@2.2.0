 ...
 * @version  v1.0.0
 * @date     04-06-2025
 * @brief    Pin MUX and Pin Config settings for "DevKit C (DK-E1C)"
...
const struct pinconf board_pinconf[] = {
    ...
    /* Selected:  SD_CMD_B */
    {PORT_2, PIN_6, PINMUX_ALTERNATE_FUNCTION_5, PADCTRL_READ_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

    /* P2_7 on pin M6. Functions: [0]: GPIO2_7, [1]: UART4_TX_A, [2]: I2S0_WS_B, [3]: I2C1_SCL_B, [4]: FAULT3_B, [5]: >>>SD_CLK_B<<<, [6]: ANA_S15, [7]: CX_BLE_RX */
    /* Selected:  SD_CLK_B */
    {PORT_2, PIN_7, PINMUX_ALTERNATE_FUNCTION_5, PADCTRL_READ_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
    ...
    /* Selected: SD_D0_B */
    {PORT_6, PIN_0, PINMUX_ALTERNATE_FUNCTION_5, PADCTRL_READ_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

    /* P6_1 on pin B11. Functions: [0]:GPIO6_1, [1]: OSPI0_D1_C, [2]: UART5_DE_A, [3]: SPI1_MISO_B, [4]: UT0_T1_B, [5]:  >>>SD_D1_B<<<, [6]: CDC_D9_A, [7]: BLE_DBG17 */
    /* Selected: SD_D1_B */
    {PORT_6, PIN_1, PINMUX_ALTERNATE_FUNCTION_5, PADCTRL_READ_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
    ...
    /* Selected: SD_D2_B */
    {PORT_6, PIN_2, PINMUX_ALTERNATE_FUNCTION_5, PADCTRL_READ_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
    ...
    /* Selected: SD_D3_B */
    {PORT_6, PIN_3, PINMUX_ALTERNATE_FUNCTION_5, PADCTRL_READ_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
